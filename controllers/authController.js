...
const { firstNameValidation, lastNameValidation, emailValidation, passwordValidation, confirmPasswordValidation, userTypeValidation, termsValidation } = require('./Validation');
...
exports.getResetPassword = (req,res,next) => {
  ...
  res.render("auth/reset_password",{pageTitle:"Reset Password",isLoggedIn:false,email:email,})
}
...
exports.postResetPassword = [
 ...
 {
    res.render("auth/reset_password",{pageTitle:"Reset Password",isLoggedIn:false,email:email,errorMessages : [err.message]})
 }
}];
